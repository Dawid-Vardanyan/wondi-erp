<?php
  ...
  if($init["firstInit"] != 1 || $_SESSION['fPwdCrt'] != 1){
...
<div class="h-screen">
  <section class="container mx-auto">
    ...
    <section class="w-2/3 mx-auto mt-20">
      <form action = "functions/init_add_user.php" method="post">
        ...
        <div class="containner px-20 my-20 mx-auto">
          <div class="divide-y">
            <div class="flex items-start space-x-3 py-6">
              <input id="input-admin" type="radio" checked name="uprawnienia" value="admin" class="border-gray-300 rounded h-5 w-5" />
