  ...
  <section class="container mx-auto">
    ...
    <h2 class="text-3xl font-bold text-center">Zarządzanie rejestrem pracowników</h2>
      <div class="grid grid-cols-2 gap-16 mt-10">
        <a href="panel_add_project.php" class="block bg-primary text-white p-24 text-center font-bold text-lg">
            Panel dodawania projektów
        </a>
        <a href="panel_projects_list.php" class="block bg-primary text-white p-24 text-center font-bold text-lg">
            Lista projektów
        </a>
      </div>
    </section>
