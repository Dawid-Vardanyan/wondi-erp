...
<div class="h-screen">
  <section class="container mx-auto">
    ...
    <section class="w-2/3 mx-auto mt-20">
      <h2 class="text-3xl font-bold text-center">Lista projektów</h2>
      <table class="table-auto mt-20 w-full border border-collapse text-left">
        ...
        <?php include('functions/projects_list.php'); ?>
      </table>
      
      <div class="text-center">
        <a href="panel_add_project.php" class="mt-8 rounded bg-primary text-white inline-block py-2 px-8 font-bold">Dodaj projekt</a>
      </div>
