...
<head>
    ...
    <title>Pobieranie faktury</title>
</head>
<body>
<div class="h-screen">
  <section class="container mx-auto">
    ...
    <section class="w-2/3 mx-auto mt-20">
      <h2 class="text-3xl font-bold text-center">Pobieranie faktur</h2>
      <form class="mt-10" method = "POST" action = "functions/download_invoice.php">
        <div class="flex justify-center">
          <div class="mb-3 xl:w-96 relative">
            <select name="pobieraniefaktury" class="form-select appearance-none
      block
      w-full
      px-3
      py-1.5
      ...
      focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
        ...
        <div class="text-center">
          <input type="submit" class="mt-8 rounded bg-primary text-white inline-block py-2 px-8 font-bold cursor-pointer" value="Pobierz fakturę" />
        </div>
      </form>
